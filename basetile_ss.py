...
class BasetileSs(Basetile):
    ...
    def modify_ss_ps_plot(self, outdir, org_cmd, new_cmd, logo, display=False):
    ...
    def make_ss_ps_plot(self, outdir, logo):
        ...
        if path.isfile(outdir+self.nc_grid['tile']):
            ...
            self.modify_ss_ps_plot(outdir, outdir+self.ps_map['shell'], outdir+self.ps_map['lcc_shell'], logo)
