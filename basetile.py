...
{ulx} {uly}'''.format(ulx=self.region['ul'][0], \
    ...
    def lam2geo_carto(self, outdir, org_cmd, new_cmd):
        ...
        new_dict['Make basemap']['Annotation'] = "        -B5m/5m \\\n"
    ...
    def make_ps_map(self, outdir):
        ...
        if path.isfile(outdir+self.nc_grid_tile):
            ...
            self.lam2geo_carto(outdir, outdir+self.ps_map_shell, outdir+self.ps_map_lcc_shell)
