...
class BasetileAmp(Basetile):
    ...
    def modify_amp_ps_plot(self, outdir, org_cmd, new_cmd, logo, display=False):
        ...
        new_dict['Run evince']['Dont_Execute'] = "# evince   %s &\n" % (outdir+self.ps_map['lcc_map'])
        ...
        for index, line in enumerate(org_lines):
            ...
            if 'shell variables' in line:
                ...
                if display:
                    ...
                    new_lines[index + 2] = new_dict['Run evince']['Dont_Execute']
    ...
    def make_amp_ps_plot(self, outdir, logo):
        ...
        if path.isfile(outdir+self.nc_grid['tile']):
            ...
            self.modify_amp_ps_plot(outdir, outdir+self.ps_map['shell'], outdir+self.ps_map['lcc_shell'], logo)
